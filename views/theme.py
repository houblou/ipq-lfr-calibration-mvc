...
def btn(parent, text, command, color=None, fgcolor=None,
        font=FONT, padx=12, pady=5):
    return tk.Button(
        parent, text=text, command=command,
        font=font, bg=color or C["bg_active"], fg=fgcolor or C["txt_active"],
...
def btn_noir(parent, text, command, font=FONT, padx=14, pady=7):
    ...
    return tk.Button(
        parent, text=text, command=command,
        font=font, bg=NOIR, fg="#ffffff",
        activebackground=NOIR_HOVER, activeforeground="#ffffff",
        relief="flat", bd=0, padx=padx, pady=pady, cursor="hand2",
    )


def btn_accent(parent, text, command, color, fgcolor="#ffffff",
               active=None, font=FONT_BOLD, padx=16, pady=8):
    """Bouton à accent plein (violet / vert / rouge)."""
    return tk.Button(
        parent, text=text, command=command,
        font=font, bg=color, fg=fgcolor,
        activebackground=active or color, activeforeground=fgcolor,
        relief="flat", bd=0, padx=padx, pady=pady, cursor="hand2",
    )
